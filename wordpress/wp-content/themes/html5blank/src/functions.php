...
function html5blank_header_scripts() {
    if ( $GLOBALS['pagenow'] != 'wp-login.php' && ! is_admin() ) {
        if ( HTML5_DEBUG ) {
            ...
            wp_localize_script( 'html5blankscripts', 'frontend_ajax_object',
                array( 
        ...
        // If production
            ...
            wp_localize_script( 'html5blankscripts-min', 'frontend_ajax_object',
                array( 
                    'ajaxurl' => admin_url( 'admin-ajax.php' ),
                )
            );
...
function html5blank_styles() {
    if ( HTML5_DEBUG ) {
        ...
        // Custom CSS
        wp_register_style( 'html5blankCustom', get_template_directory_uri() . '/css/style.css', array( 'normalize' ), '1.0' );

        // Register CSS
        wp_enqueue_style( 'html5blank' );
        wp_enqueue_style( 'html5blankCustom' );
    } else {
        // Custom CSS
